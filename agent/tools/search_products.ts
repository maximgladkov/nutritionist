...
export default defineTool({
  description:
    "Search packaged foods by product name in Open Food Facts and the shared catalog. Uses the user's saved country unless country is passed. Pass country only to override for a product from another country. Do not call this as the user types.",
