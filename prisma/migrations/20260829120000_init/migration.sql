...
CREATE TABLE "AgentSession" (
    ...
    CONSTRAINT "AgentSession_pkey" PRIMARY KEY ("eveSessionId")
);

-- CreateTable
CREATE TABLE "MemoryDocument" (
    "userId" TEXT NOT NULL,
    "slot" TEXT NOT NULL DEFAULT 'profile',
    "scopeKey" TEXT,
    "content" TEXT NOT NULL DEFAULT '{"lastAllocatedIndex":-1,"entries":[]}',
    "version" INTEGER NOT NULL DEFAULT 0,
    "updatedAt" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "MemoryDocument_pkey" PRIMARY KEY ("userId","slot")
);
...
-- CreateTable
CREATE TABLE "ChatSdkEntry" (
    "key" TEXT NOT NULL,
    "value" JSONB NOT NULL,
    "expiresAt" TIMESTAMP(3),
    "updatedAt" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "ChatSdkEntry_pkey" PRIMARY KEY ("key")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "ChannelIdentity_provider_providerUserId_key" ON "ChannelIdentity"("provider", "providerUserId");
